  ...
  <Teleport to="body">
    ...
    >
      ...
      <template v-else-if="openFlyout === 'account'">
        ...
        <button @click="closeFlyout(); emit('navigate', 'refer')" class="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-ditto-text hover:bg-ditto-light-grey transition-colors text-left">
        ...
        <button @click="closeFlyout(); emit('navigate', 'patterns')" class="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-ditto-text hover:bg-ditto-light-grey transition-colors text-left">
          <svg class="w-4 h-4 opacity-60" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
