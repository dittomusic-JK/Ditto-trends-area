<template>
  <div>
    ...
    <div class="border border-gray-200 rounded-2xl p-6 lg:p-8">
      ...
      <p v-else-if="(form.motionArtwork.square.status === 'valid' || form.motionArtwork.portrait.status === 'valid') && !form.selectedStores.includes('apple-music')" class="text-xs text-[#92400e] bg-warning/15 rounded-lg px-3 py-2 mt-4 inline-flex items-center gap-2">
